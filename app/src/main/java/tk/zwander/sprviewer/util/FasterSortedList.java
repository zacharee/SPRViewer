 ...
 */
public class FasterSortedList<T> extends AbstractList<T> implements Serializable {
     ...
     */
    public FasterSortedList(Comparator<? super T> comparator){
     ...
     */
    boolean structurallyEqualTo(FasterSortedList<T> other){
    ...
    private class Itr implements Iterator<T> {
		...
		public void remove() {
			...
			FasterSortedList.this.remove(lastReturned);
			lastReturned = null;
